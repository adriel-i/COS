...
null, "Adriel", "Irala", 40820180, '1998/03/03', "Argentina", 1);
...
insert into estados_usuarios values(
null, "Activo");

insert into usuarios values(
null, "campana98", "airala", 1, 1, 1, 1);

update personas set id_genero = 1 where id_persona = 1;

select * from personas;

SELECT * FROM usuarios u JOIN personas p ON p.id_persona = u.id_persona WHERE username = 'airala' and contrasena = 'campana98' and u.id_estado_usuario=1